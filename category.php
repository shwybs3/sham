...
$seoTitle = "أفضل تطبيقات وألعاب {$category['name']} لأندرويد — تحميل مجاني | Apkzilo";
$metaDesc = !empty($category['description'])
    ? mb_substr(trim(strip_tags($category['description'])), 0, 160)
    : "تصفح وحمّل أفضل {$category['name']} لأندرويد مجاناً وبسرعة على Apkzilo — تحديث مستمر وروابط تحميل مباشرة.";
