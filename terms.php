...
$seoTitle = 'شروط الاستخدام — Apkzilo';
$metaDesc = 'شروط استخدام منصة Apkzilo لتحميل التطبيقات والألعاب.';
?>
<!DOCTYPE html>
...
<main class="main-content">
  ...
  <div class="section-box reveal" style="color:var(--muted);font-size:14px;line-height:1.9">
    <p>يرجى قراءة هذه الشروط بعناية قبل استخدام موقع Apkzilo. باستخدامك للموقع فإنك توافق على الالتزام بهذه الشروط بالكامل.</p>
    ...
    <p>Apkzilo منصة عربية تعمل كدليل لعرض معلومات عن تطبيقات وألعاب أندرويد (الاسم، الوصف، الإصدار، الصور) وتوجيه الزوار نحو روابط تحميل، سواء كانت رسمية من مطوّري التطبيقات أو من مصادر خارجية موثوقة. الموقع ليس الجهة المطوّرة لهذه التطبيقات ما لم يُذكر ذلك صراحةً.</p>
    ...
    <p>جميع أسماء التطبيقات والعلامات التجارية والشعارات الظاهرة في الموقع مملوكة لأصحابها الأصليين. يحتفظ Apkzilo بحقوق التصميم والمحتوى الأصلي الخاص بالموقع نفسه (النصوص التعريفية، التصميم، الشعار).</p>

    <h3 style="color:var(--white);margin:22px 0 8px;font-size:16px">٦. حدود المسؤولية</h3>
    <p>يُقدَّم الموقع "كما هو" دون أي ضمانات صريحة أو ضمنية. لن يكون Apkzilo مسؤولاً عن أي أضرار مباشرة أو غير مباشرة تنتج عن استخدام الموقع أو التعذر عن استخدامه.</p>
