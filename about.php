...
$seoTitle = 'من نحن — Tenzil دليل تحريري مستقل لتطبيقات أندرويد';
$metaDesc = 'تعرّف على Tenzil: دليل تحريري عربي مستقل لمراجعة تطبيقات وألعاب أندرويد. رسالتنا، معايير المراجعة، وكيف نختار التطبيقات ونحدّث محتوانا يومياً.';
?>
<!DOCTYPE html>
...
<main class="main-content">
  ...
  <div class="section-box reveal" style="background:linear-gradient(135deg,rgba(6,182,212,.07),rgba(124,58,237,.05));border-color:rgba(6,182,212,.2);margin-bottom:16px">
    ...
    <p style="color:var(--muted);font-size:14px;line-height:1.85;margin:0">
      Tenzil منصة تحريرية مستقلة تأسّست عام 2024 بهدف واحد: تمكين المستخدم العربي من اتخاذ قرارات مدروسة وواثقة عند اختيار تطبيقات هاتفه. نؤمن أن لكل مستخدم الحق في الحصول على معلومات دقيقة وصادقة — لا إعلانات مقنّعة، لا توصيات مدفوعة، لا مبالغات تسويقية.
    </p>
  </div>
  ...
  <div class="section-box reveal" style="color:var(--muted);font-size:14px;line-height:1.9">
    ...
    <p>
      Tenzil ليس تابعاً لأي شركة تطبيقات أو متجر رقمي.
    ...
    <p>
      خلف Tenzil فريق صغير من المهتمين بعالم تطبيقات أندرويد والتكنولوجيا العربية، يديرون الموقع بشغف حقيقي لخدمة المستخدم العربي.
