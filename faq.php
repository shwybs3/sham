...
$faqs = [
    'عن yassota' => [
        ['q' => 'ما هو موقع yassota؟',
         'a' => 'yassota هو دليل تحريري عربي مستقل متخصص في مراجعة وتقييم تطبيقات وألعاب أندرويد. يقدم الموقع محتوى تحريرياً دقيقاً ومحايداً يساعد المستخدمين العرب على اكتشاف أفضل التطبيقات واتخاذ قرار التحميل بثقة.'],
        ['q' => 'هل yassota موقع رسمي لـ Google Play أو أي شركة تطبيقات؟',
         'a' => 'لا، yassota موقع تحريري مستقل تماماً ولا ينتمي لأي متجر تطبيقات أو شركة برمجيات. نحن نراجع التطبيقات بشكل موضوعي ونضع روابط تحميل من المصادر الرسمية مثل Google Play أو من المطورين مباشرة.'],
        ['q' => 'كيف يعمل فريق yassota؟',
         'a' => 'يضم فريق yassota محررين متخصصين في عالم التطبيقات يراجعون كل تطبيق قبل نشره، يتحققون من جودة الرابط وأمانه، ويكتبون وصفاً تفصيلياً بالعربية يغطي المميزات والعيوب واستخدامات التطبيق.'],
        ['q' => 'هل الموقع مجاني للاستخدام؟',
         'a' => 'نعم، yassota مجاني تماماً للمستخدمين. يعتمد الموقع على الإعلانات لتغطية تكاليف التشغيل. لا توجد رسوم اشتراك أو مدفوعات مخفية من أي نوع.'],
    ],
    'التحميل والروابط' => [
        ['q' => 'كيف أحمّل التطبيق من yassota؟',
        ...
        ['q' => 'هل روابط التحميل آمنة؟',
         'a' => 'نعم، جميع روابط التحميل على yassota تُفحص قبل نشرها. نعتمد على روابط Google Play الرسمية كمصدر أساسي، وعند توفر ملفات APK مباشرة نتحقق منها بأدوات فحص الفيروسات ونعرض نتيجة الفحص بجانب الرابط.'],
        ...
        ['q' => 'هل يمكنني تحميل تطبيقات لأجهزة iOS من yassota؟',
         'a' => 'لا، يتخصص yassota حالياً في تطبيقات أندرويد فقط. جميع التطبيقات المدرجة مخصصة لأجهزة Android ونظام التشغيل Android.'],
    ...
    'التقييمات والمراجعات' => [
        ['q' => 'كيف تُحسب تقييمات التطبيقات على yassota؟',
         'a' => 'تقييمات yassota مزيج من تقييم فريق التحرير بناءً على تجربة فعلية مع التطبيق، وتقييمات المستخدمين المقدَّمة عبر قسم التعليقات. يظهر التقييم الإجمالي من 5 نجوم في أعلى كل صفحة تطبيق.'],
        ...
        ['q' => 'هل التعليقات على yassota حقيقية؟',
    ...
    'المحتوى والسياسات' => [
        ['q' => 'كيف أطلب إضافة تطبيق لـ yassota؟',
        ...
        ['q' => 'ما هو برنامج الشراكة الإعلانية على yassota؟',
         'a' => 'يستخدم yassota برنامج Google AdSense لعرض إعلانات مناسبة. هذه الإعلانات تلقائية ولا تؤثر على موضوعية مراجعاتنا. للاستفسارات الإعلانية الأخرى تواصل معنا مباشرة.'],
    ],
    'الخصوصية والبيانات' => [
        ['q' => 'هل يحتاج yassota لتسجيل حساب؟',
         'a' => 'لا، يمكنك تصفح جميع محتويات yassota ومراجعة التطبيقات والتحميل بدون إنشاء حساب. التعليقات تتطلب فقط اسماً مستعاراً دون بريد إلكتروني أو حساب.'],
        ['q' => 'ما البيانات التي يجمعها yassota؟',
         'a' => 'يجمع yassota بيانات مجهولة الهوية عن استخدام الموقع (الصفحات المزارة، وقت الزيارة) عبر ملفات تعريف الارتباط (Cookies) لتحسين تجربة الاستخدام وعرض إعلانات مناسبة. لا نجمع بيانات شخصية دون موافقتك. اقرأ <a href="' . h(url('privacy-policy')) . '">سياسة الخصوصية</a> للتفاصيل الكاملة.'],
        ['q' => 'كيف يمكنني حذف بياناتي من yassota؟',
...
$seoTitle = 'الأسئلة الشائعة — yassota';
...
<main class="main-content">
  ...
  <div style="background:linear-gradient(135deg,rgba(37,99,235,.06),rgba(124,58,237,.06));border:1px solid var(--border-p);border-radius:var(--radius-lg);padding:32px 28px;text-align:center;margin-bottom:24px" class="reveal">
    ...
    <p style="color:var(--muted);font-size:14px;max-width:500px;margin:0 auto">
      إجابات شاملة على كل ما يدور في ذهنك حول yassota — التحميل، الأمان، المراجعات، والخصوصية.
    </p>
  </div>
  ...
  <div class="newsletter-box reveal" style="margin-top:8px;text-align:center">
    ...
    <p style="color:var(--muted);font-size:14px;max-width:420px;margin:0 auto 18px">
      فريق yassota جاهز للإجابة على أي استفسار — تواصل معنا مباشرة وسنرد خلال 24 ساعة.
    </p>
