...
$seoTitle = 'DMCA — سياسة حقوق النشر — Tenzil';
$metaDesc = 'كيفية تقديم بلاغ إزالة محتوى بموجب DMCA على منصة Tenzil.';
?>
<!DOCTYPE html>
...
<main class="main-content">
  ...
  <div class="section-box reveal" style="color:var(--muted);font-size:14px;line-height:1.9">
    <p>يحترم موقع Tenzil حقوق الملكية الفكرية للغير، ويستجيب لبلاغات إزالة المحتوى المخالف بموجب قانون الألفية الرقمية لحقوق النشر (DMCA) أو ما يعادله من قوانين محلية. الموقع دليل معلوماتي يعرض بيانات عن تطبيقات ويوجّه لروابط تحميل خارجية في الغالب، ولا يستضيف بنفسه محتوى محمياً بحقوق نشر عمداً.</p>
    ...
    <ol style="padding-inline-start:22px;display:flex;flex-direction:column;gap:8px;margin-top:10px">
      ...
      <li>الرابط (URL) المباشر للصفحة المخالفة على Tenzil.</li>
