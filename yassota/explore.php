...
<div class="chips">
  ...
  <a class="chip" href="<?= e(url('trending')) ?>">🔥 الترند</a>
  <a class="chip" href="<?= e(url('videos')) ?>">🎬 فيديوهات</a>
  <?php foreach ($cats as $c): ?><a class="chip" href="<?= e(category_url($c['slug'])) ?>"><?= e($c['name']) ?></a><?php endforeach; ?>
</div>
<?php if ($rows): ?>
