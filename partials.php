...
<header class="site-header">
  <a href="/" class="logo" style="display:flex;flex-direction:column;line-height:1;gap:2px">
    <span>Ten<span style="color:var(--purple)">zil</span></span>
...
<aside class="sidebar">
  ...
  <div class="sidebar-section">
    <div class="sidebar-title">Tenzil</div>
...
<footer class="site-footer" style="padding:0">
  <div style="max-width:100%;padding:36px 32px 24px;border-top:1px solid var(--border-c)">
    ...
    <div style="display:grid;grid-template-columns:2fr 1fr 1fr;gap:32px;margin-bottom:28px">
      ...
      <!-- Brand -->
      <div>
        <div class="footer-logo" style="margin-bottom:10px">Ten<span style="color:var(--purple)">zil</span></div>
        ...
        <p style="color:var(--muted);font-size:11px;line-height:1.65;padding-top:12px;border-top:1px solid var(--border-c);margin:0">
          Tenzil موقع تحريري مستقل لمراجعة التطبيقات ولا ينتمي لأي متجر أو شركة تطبيقات.
      ...
      <!-- Col 2 -->
      <div>
        <div style="font-size:11px;font-weight:700;letter-spacing:1.2px;color:var(--muted);text-transform:uppercase;margin-bottom:14px">Tenzil</div>
        <?php foreach ([
            url('about')          => 'من نحن',
    ...
    <div style="border-top:1px solid var(--border-c);padding-top:16px;display:flex;flex-wrap:wrap;gap:10px;align-items:center;justify-content:space-between">
      <p style="font-size:11px;color:var(--muted);margin:0">
        &copy; 2024–<?= date('Y') ?> Tenzil — جميع الحقوق محفوظة | دليل تحريري مستقل لتطبيقات أندرويد
      </p>
      <p style="font-size:11px;color:var(--muted);margin:0">
...
<div id="cookie-consent" class="cookie-consent cookie-consent-v2" hidden>
  ...
  <div class="cc-text">
    ...
    <p>باستخدام Tenzil فإنك توافق على <a href="<?= h(url('cookie-policy')) ?>">سياسة ملفات تعريف الارتباط</a>،
