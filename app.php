...
function svgi(string $n): string {
    $i = [
        ...
        'check' => '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2fce77" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg>',
        'x'     => '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#f06565" stroke-width="2.5"><path d="M18 6L6 18M6 6l12 12"/></svg>',
        ...
        'star'  => '<svg width="14" height="14" viewBox="0 0 24 24" fill="#f0b429" stroke="#f0b429" stroke-width="1"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',
  ...
  <section class="app-hero reveal">
    <div class="app-hero-inner">
      <div class="app-hero-icon-wrap">
        ...
        <?php else: ?>
          <div class="app-hero-icon" style="background:linear-gradient(135deg,var(--navy-500),var(--navy-400));display:flex;align-items:center;justify-content:center">
            <?= svgi('android') ?>
          </div>
        <?php endif; ?>
      </div>
  ...
  <div class="section-box reveal">
    ...
    <div style="overflow-x:auto">
      <table class="admin-table" style="width:100%;min-width:480px">
        ...
        <tbody>
          <tr style="background:rgba(34,224,168,.04)">
    ...
    <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:20px">
      ...
      <div style="background:var(--navy-600);border:1px solid var(--border-c);border-radius:12px;padding:14px 16px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
          ...
          <span style="color:#f0b429;font-family:var(--f-mono);font-size:12px"><?= str_repeat('★', (int)$c['rating']) . str_repeat('☆', 5 - (int)$c['rating']) ?></span>
        </div>
