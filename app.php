...
// Include aggregateRating only when there is a genuine rating backed by a real
// review count — a rating with no real count behind it is a fabricated Rich
// Result and violates Google's structured-data guidelines.
    ...
    <div class="app-hero-inner">
      ...
      <div class="app-hero-info">
        ...
        <div class="app-badges">
          ...
          <?php if (!empty($app['rating'])): ?><span class="badge badge-gold"><?= svgi('star') ?> <?= h($app['rating']) ?></span><?php endif; ?>
          <?php
            $b = $app['badge'] ?? '';
      ...
      <a class="app-card-inner" href="<?= h(app_url($r['slug'])) ?>" data-hardnav="1">
        <div class="app-card-body" style="padding-top:14px">
          ...
          <div class="app-card-meta">
            <?php if (!empty($r['rating'])): ?><div class="app-card-rating"><?= svgi('star') ?> <?= h($r['rating']) ?></div><?php endif; ?>
          </div>
        </div>
      </a>
