...
'ar' => [
  ...
  'manage_tools'      => 'إدارة أدوات الويب',
  'add_tool'          => 'إضافة أداة',
  'add_tool_new'      => 'إضف أداة جديدة',
  'edit_tool'         => 'تعديل الأداة',
  'delete_tool'       => 'حذف الأداة',
  'tool_name'         => 'اسم الأداة',
  'tool_slug'         => 'الرابط النهائي',
  'tool_description'  => 'الوصف القصير',
  'tool_long_desc'    => 'الوصف الطويل',
  'tool_features'     => 'المميزات',
  'tool_pros'         => 'الإيجابيات',
  'tool_cons'         => 'السلبيات',
  'tool_tutorials'    => 'الشروحات',
  'tool_faq'          => 'الأسئلة الشائعة',
  'tool_whats_new'    => 'ما الجديد',
  'tool_status'       => 'الحالة',
  'tool_views'        => 'المشاهدات',
  'tool_created'      => 'تاريخ الإنشاء',
  'tool_updated'      => 'تاريخ التحديث',
  'tool_actions'      => 'الإجراءات',
  'tool_search'       => 'البحث عن أداة',
  'tool_filter'       => 'تصفية',
  'tool_published'    => 'منشورة',
  'tool_draft'        => 'مسودة',
  'tool_live_preview' => 'معاينة حية',
  'tool_publish'      => 'نشر',
  'tool_unpublish'    => 'إلغاء النشر',
  'tool_save'         => 'حفظ',
  'tool_cancel'       => 'إلغاء',
  'tool_delete_confirm' => 'هل تأكد من حذف هذه الأداة؟',
  'no_tools'          => 'لا توجد أدوات',
  'name'              => 'الاسم',
  'action'            => 'الإجراء',
  'slug'              => 'الرابط',
  'status'            => 'الحالة',
...
'en' => [
  ...
  'tool_pros'         => 'Pros',
  'tool_cons'         => 'Cons',
  'tool_tutorials'    => 'Tutorials',
  'tool_faq'          => 'FAQ',
  'tool_whats_new'    => 'What\'s New',
  'tool_status'       => 'Status',
  'tool_views'        => 'Views',
  'tool_created'      => 'Created Date',
  'tool_updated'      => 'Updated Date',
  'tool_actions'      => 'Actions',
  'tool_search'       => 'Search Tools',
  'tool_filter'       => 'Filter',
  'tool_published'    => 'Published',
  'tool_draft'        => 'Draft',
  'tool_live_preview' => 'Live Preview',
  'tool_publish'      => 'Publish',
  'tool_unpublish'    => 'Unpublish',
  'tool_save'         => 'Save',
  'tool_cancel'       => 'Cancel',
  'tool_delete_confirm' => 'Are you sure you want to delete this tool?',
...
'fr' => [
  ...
  'manage_tools'=>'Gérer les outils Web','add_tool'=>'Ajouter un outil','add_tool_new'=>'Ajouter un nouvel outil',
  'edit_tool'=>'Modifier l\'outil','delete_tool'=>'Supprimer l\'outil','tool_name'=>'Nom de l\'outil',
  'tool_slug'=>'URL Slug','tool_description'=>'Description courte','tool_long_desc'=>'Description longue',
  'tool_features'=>'Fonctionnalités','tool_pros'=>'Avantages','tool_cons'=>'Inconvénients',
  'tool_tutorials'=>'Tutoriels','tool_faq'=>'FAQ','tool_whats_new'=>'Quoi de neuf',
  'tool_status'=>'Statut','tool_views'=>'Vues','tool_created'=>'Date de création',
  'tool_updated'=>'Date de mise à jour','tool_actions'=>'Actions','tool_search'=>'Rechercher des outils',
  'tool_filter'=>'Filtrer','tool_published'=>'Publié','tool_draft'=>'Brouillon',
  'tool_live_preview'=>'Aperçu en direct','tool_publish'=>'Publier','tool_unpublish'=>'Dépublier',
  'tool_save'=>'Enregistrer','tool_cancel'=>'Annuler','tool_delete_confirm'=>'Êtes-vous sûr de vouloir supprimer cet outil?',
  'no_tools'=>'Aucun outil trouvé','name'=>'Nom','action'=>'Action','slug'=>'Slug',
  'status'=>'Statut','views'=>'Vues','date'=>'Date','edit'=>'Modifier','delete'=>'Supprimer',
  'save'=>'Enregistrer','cancel'=>'Annuler','search'=>'Rechercher','add'=>'Ajouter','required'=>'Requis',
  'back'=>'Retour à la liste','added_success'=>'Ajouté avec succès','updated_success'=>'Mis à jour avec succès','deleted_success'=>'Supprimé avec succès',
],
