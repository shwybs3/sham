...
'ar' => [
  ...
  'discover'            => 'اكتشف',
  'yassota_section'     => 'yassota',
  'cookie_policy'       => 'سياسة الكوكيز',
  'disclosure_link'     => 'الإفصاح الإعلاني',
  'dmca_link'           => 'DMCA وإزالة المحتوى',
  'footer_tagline'      => 'دليلك التحريري العربي المستقل لاكتشاف ومراجعة تطبيقات أندرويد — مراجعات دقيقة، معلومات موثوقة، ومحتوى محدّث باستمرار.',
  'footer_disclaimer'   => 'yassota موقع تحريري مستقل لمراجعة التطبيقات ولا ينتمي لأي متجر أو شركة تطبيقات. بعض روابط التحميل توجّه إلى Google Play أو مصادر رسمية أخرى. يحتوي الموقع على إعلانات من Google AdSense.',
  'editorial_oversight' => 'تحت إشراف تحريري — المحتوى يُحدَّث يومياً',
  'cookie_banner_title' => 'نستخدم ملفات تعريف الارتباط (Cookies)',
  'cookie_banner_text'  => 'يستخدم yassota cookies ضرورية للتشغيل، وبموافقتك: إعلانات Google AdSense مخصصة وإحصاءات الزيارات.',
  'accept_all'          => 'قبول الكل',
  'essential_only'      => 'الضروري فقط',
  'privacy_notice'      => 'إشعار الخصوصية',
  'review_word'         => 'راجع',
  'and_word'            => 'و',
  'reviewed_by_team'    => 'تمت مراجعته من قِبَل فريق yassota',
  ...
  'permissions_warning' => 'صلاحيات باللون الأحمر قد تكون حساسة — تأكد من فهم سبب حاجة التطبيق لها قبل المنح.',
  'current_version'     => 'الحالي',
  'prev_versions'       => 'الإصدارات السابقة',
  'download_this_version' => 'تحميل هذا الإصدار',
  'subscribe_telegram'  => 'اشترك في قناة yassota على تيليجرام',
  'what_does_offer'     => 'ماذا يقدّم',
  'useful_tools'        => '🔧 أدوات مفيدة',
  'version_col'         => 'الإصدار',
  'date_col'            => 'التاريخ',
  'changes_col'         => 'التغييرات',
  'file_integrity_check'=> 'التحقق من سلامة الملف (SHA-256 / MD5)',
  'browse'              => 'تصفح',
  'views_label'          => 'مشاهدة',
  'free_web_tools'       => 'أدوات الويب المجانية',
  'free_web_tools_desc'  => 'مجموعة شاملة من أدوات الويب المجانية لتسهيل عملك',
  'no_tools_available'   => 'لا توجد أدوات متاحة حالياً',
  'popular_apps_you_like'=> 'تطبيقات مشهورة قد تهمك',
  'complete_experience'  => 'استكمل تجربتك باستخدام أفضل التطبيقات الأكثر تحميلاً',
  'view_all_apps'        => 'عرض جميع التطبيقات',
  'overview'              => 'نظرة عامة',
  'main_features'         => 'المميزات الرئيسية',
  'tool_not_found'        => 'أداة غير موجودة',
  'how_to_use_tutorials'  => 'كيفية الاستخدام والشروحات',
  'apps_you_may_like'     => 'تطبيقات قد تهمك',
  'how_it_started_label'  => 'كيف بدأت هذه الأداة',
  'faq_heading'           => 'أسئلة شائعة',
  'latest_updates_heading'=> 'آخر التحديثات',
  'tools_complete_experience' => 'أدوات تكمل تجربتك',
  'view_all_tools_count'  => 'عرض جميع الأدوات',
  'no_apps_in_category'   => 'لا توجد تطبيقات في هذا التصنيف بعد',
  'no_updates_today'      => 'لا توجد تحديثات اليوم بعد',
  'no_updates_yet'        => 'لا توجد تحديثات بعد',
  'press_esc_close'       => 'اضغط Esc للإغلاق',
  'all_tools_label'       => 'جميع الأدوات',
...
'en' => [
  ...
  'dmca_link'           => 'DMCA & Content Removal',
  'footer_tagline'      => 'Your independent Arabic editorial guide to discovering and reviewing Android apps — accurate reviews, trustworthy information, and constantly updated content.',
  'footer_disclaimer'   => 'yassota is an independent editorial site for app reviews and is not affiliated with any app store or company. Some download links point to Google Play or other official sources. This site displays Google AdSense ads.',
  'editorial_oversight' => 'Editorially reviewed — content updated daily',
  'cookie_banner_title' => 'We use cookies',
  'cookie_banner_text'  => 'yassota uses essential cookies for operation, and with your consent: personalized Google AdSense ads and visit analytics.',
  'accept_all'          => 'Accept All',
  'essential_only'      => 'Essential Only',
  'privacy_notice'      => 'Privacy Notice',
  'review_word'         => 'Review',
  'and_word'            => 'and',
  'reviewed_by_team'    => 'Reviewed by the yassota team',
  ...
  'permissions_warning' => 'Permissions in red may be sensitive — make sure you understand why the app needs them before granting.',
  'current_version'     => 'Current',
  'prev_versions'       => 'Previous Versions',
  'download_this_version' => 'Download This Version',
  'subscribe_telegram'  => 'Subscribe to the yassota Telegram channel',
  'what_does_offer'     => 'What does',
  'useful_tools'        => '🔧 Useful Tools',
  'version_col'         => 'Version',
  'date_col'            => 'Date',
  'changes_col'         => 'Changes',
  'file_integrity_check'=> 'Verify File Integrity (SHA-256 / MD5)',
  'browse'              => 'Browse',
  'views_label'          => 'views',
  'free_web_tools'       => 'Free Web Tools',
  'free_web_tools_desc'  => 'A comprehensive collection of free web tools to make your work easier',
  'no_tools_available'   => 'No tools available right now',
  'popular_apps_you_like'=> 'Popular apps you might like',
  'complete_experience'  => 'Complete your experience with the best top-downloaded apps',
  'view_all_apps'        => 'View All Apps',
  'overview'              => 'Overview',
  'main_features'         => 'Main Features',
  'tool_not_found'        => 'Tool not found',
  'how_to_use_tutorials'  => 'How to Use & Tutorials',
  'apps_you_may_like'     => 'Apps you might like',
  'how_it_started_label'  => 'How This Tool Started',
  'faq_heading'           => 'Frequently Asked Questions',
  'latest_updates_heading'=> 'Latest Updates',
  'tools_complete_experience' => 'Tools that complete your experience',
  'view_all_tools_count'  => 'View All Tools',
  'no_apps_in_category'   => 'No apps in this category yet',
  'no_updates_today'      => 'No updates today yet',
  'no_updates_yet'        => 'No updates yet',
  'press_esc_close'       => 'Press Esc to close',
  'all_tools_label'       => 'All Tools',
  'content_label'         => 'Content',
  'sections_label'        => 'Categories',
