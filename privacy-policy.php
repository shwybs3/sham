...
<main class="main-content">
  ...
  <div class="section-box reveal" style="color:var(--muted);font-size:14px;line-height:1.9">
    ...
    <p>يستخدم الموقع ملفات تعريف ارتباط أساسية لعمل الجلسة، بالإضافة إلى ملفات تعريف ارتباط من Google AdSense لعرض إعلانات ذات صلة. لمزيد من التفاصيل راجع <a href="cookie-policy.php" style="color:var(--cyan)">سياسة ملفات تعريف الارتباط</a>.</p>
