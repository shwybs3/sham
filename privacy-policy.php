...
<main class="main-content">
  <nav style="font-size:12px;color:var(--muted);margin-bottom:16px;display:flex;gap:6px;align-items:center;flex-wrap:wrap">
    <a href="index.php" style="color:var(--cyan)">الرئيسية</a><span>/</span><span>سياسة الخصوصية</span>
  </nav>
  ...
  <div class="section-box reveal" style="color:var(--muted);font-size:14px;line-height:1.9">
    ...
    <p>يستخدم الموقع ملفات تعريف ارتباط أساسية لعمل الجلسة، بالإضافة إلى ملفات تعريف ارتباط من شبكات إعلانية خارجية (مثل Google AdSense وMoneyTag) لعرض إعلانات ذات صلة. لمزيد من التفاصيل راجع <a href="cookie-policy.php" style="color:var(--cyan)">سياسة ملفات تعريف الارتباط</a>.</p>

    <h3 style="color:var(--white);margin:22px 0 8px;font-size:16px">٣. الإعلانات وأطراف ثالثة</h3>
    <p>نستخدم شبكات إعلانية تابعة لجهات خارجية، منها Google AdSense وMoneyTag، والتي قد تستخدم ملفات تعريف الارتباط وتقنيات مشابهة لعرض إعلانات مبنية على زياراتك لهذا الموقع ومواقع أخرى. يمكنك التحكم بإعلانات Google المخصصة من خلال <a href="https://adssettings.google.com" target="_blank" rel="nofollow noopener" style="color:var(--cyan)">إعدادات إعلانات Google</a>.</p>
    ...
    <p>لأي استفسار بخصوص هذه السياسة، يمكنك مراسلتنا على: <a href="mailto:<?= h($contactEmail) ?>" style="color:var(--cyan)"><?= h($contactEmail) ?></a> أو عبر <a href="contact.php" style="color:var(--cyan)">صفحة اتصل بنا</a>.</p>
  </div>
</main>
</div>
