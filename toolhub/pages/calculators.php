...
<div class="container page-body">
  ...
  <section class="seo-content card">
    <h2>📌 الدليل الشامل لحاسبات البناء والكميات</h2>
    <div class="prose">
      <h3>حساب كمية الخرسانة بدقة</h3>
      <p>كمية الخرسانة (م³) = الطول × العرض × السماكة بالمتر. لكل م³ خرسانة بنسبة الخلط 1:2:4 تحتاج تقريباً:</p>
      <ul>
        <li>8 أكياس أسمنت (كل كيس 50 كجم)</li>
        <li>0.5 م³ رمل ناعم</li>
        <li>1 م³ حصى خشن</li>
        <li>175-200 لتر ماء</li>
      </ul>
      <p>للخرسانة الإنشائية القوية (1:1.5:3) ترتفع كمية الأسمنت إلى 11-12 كيساً لكل م³.</p>

      <h3>حساب الطوب والبلاط بالطريقة الصحيحة</h3>
      <p><strong>الطوب:</strong> عدد الطوب = (طول الجدار × ارتفاعه بالمتر) ÷ (مساحة وجه الطوبة بالمتر المربع). للطوب القياسي 25×12×6 سم مع ملاط 1 سم: نحتاج ~56 طوبة لكل م². دائماً أضف 10% هدراً وكسراً.</p>
      <p><strong>البلاط:</strong> عدد القطع = (مساحة الغرفة م²) ÷ (مساحة البلاطة الواحدة م²). لبلاط 60×60 سم: 1 م² ÷ 0.36 م² = 2.78 قطعة للمتر المربع. أضف 10-15% للهدر والقطع والحواف.</p>

      <h3>وزن حديد التسليح — المعادلة الدقيقة</h3>
      <p>وزن حديد التسليح (كجم/م) = (القطر بالمم)² ÷ 162</p>
      <ul>
        <li>حديد 8 مم = 64÷162 = <strong>0.395 كجم/م</strong></li>
        <li>حديد 10 مم = 100÷162 = <strong>0.617 كجم/م</strong></li>
        <li>حديد 12 مم = 144÷162 = <strong>0.888 كجم/م</strong></li>
        <li>حديد 16 مم = 256÷162 = <strong>1.580 كجم/م</strong></li>
        <li>حديد 20 مم = 400÷162 = <strong>2.469 كجم/م</strong></li>
      </ul>

      <h3>نصائح لمقاولي ومشرفي البناء</h3>
      <ul>
        <li>اطلب عرض أسعار على الكميات بعد احتساب 5-10% زيادة كاحتياطي</li>
        <li>الأسمنت الأسرع تصلباً (رابط سريع) ضروري للأجواء الباردة تحت 10°م</li>
        <li>نسبة الماء للأسمنت (w/c ratio) هي العامل الأهم في قوة الخرسانة — لا تزد الماء</li>
        <li>للصبة التحت الأرض استخدم إضافات منع الرطوبة (crystalline waterproofing)</li>
      </ul>

      <h3>أسئلة شائعة في البناء</h3>
      <details class="faq-item" style="margin:.5rem 0">
        <summary>ما الفرق بين الأسمنت البورتلاندي وأسمنت الجبس؟</summary>
        <p>الأسمنت البورتلاندي (عادي أو سريع) يُستخدم للخرسانة والطوب، يتصلب بالتفاعل مع الماء ويكتسب قوته تدريجياً. أسمنت الجبس (البلاستر) للتشطيبات الداخلية فقط ويتصلب بالجفاف — لا يصلح للأساسات أو الخرسانة الإنشائية.</p>
      </details>
      <details class="faq-item" style="margin:.5rem 0">
        <summary>كم يجب أن تُدار الخرسانة للحصول على أفضل قوة؟</summary>
        <p>يجب ري الخرسانة بالماء (المعالجة الرطبة) لمدة 7-28 يوماً بعد الصب. المعالجة الرطبة لأول 7 أيام تحقق حوالي 75% من القوة التصميمية. تجنب الصب في درجات حرارة أقل من 5°م أو أعلى من 35°م.</p>
      </details>
    </div>
  </section>
</div>
