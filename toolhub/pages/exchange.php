...
<div class="container page-body">
  ...
  <section class="seo-content card">
    <h2>📌 دليل أسعار الصرف</h2>
    <div class="prose">
      <p>يتحدث موقع <strong><?= h(SITE_NAME) ?></strong> عن أحدث أسعار الصرف لحظة بلحظة للدولار الأمريكي واليورو والجنيه الإسترليني مقابل الريال السعودي والدرهم الإماراتي والجنيه المصري وجميع العملات العربية.</p>
      <h3>كيف تستخدم محوّل العملات؟</h3>
      <ol>
        <li>أدخل المبلغ الذي تريد تحويله</li>
        <li>اختر العملة المصدر (مثال: دولار)</li>
        <li>اختر العملة الهدف (مثال: ريال سعودي)</li>
        <li>اضغط "تحويل" للحصول على النتيجة الفورية</li>
      </ol>
      <h3>ما مصدر أسعار الصرف؟</h3>
      <p>نعتمد على بيانات من Frankfurter API المتصلة بالبنك المركزي الأوروبي، ويتم تحديث الأسعار كل ساعة.</p>
    </div>
  </section>
</div>
